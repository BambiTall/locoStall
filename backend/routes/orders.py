...
# Get orders list
@orders_bp.route(f'{os.environ["API_BASE"]}/orders')
def get_orders_list():
...
# Get orders detail
@orders_bp.route(f'{os.environ["API_BASE"]}/order_detail/<int:order_id>', methods=['GET'])
...
# Add order
@orders_bp.route(f'{os.environ["API_BASE"]}/orders', methods=['POST'])
def add_order():
